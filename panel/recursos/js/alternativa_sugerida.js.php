<?php require_once('../../globales_sistema.php');?>
    ...
    $.post('ws/alternativa_sugerida.php', {op: 'add',id:id,id_pregunta_encuesta:id_pregunta_encuesta,texto:texto,id_estudiante:id_estudiante,fecha:fecha}, function(data) {
        if(data === 0){
    ...
    $.post('ws/alternativa_sugerida.php', {op: 'mod',id:id,id_pregunta_encuesta:id_pregunta_encuesta,texto:texto,id_estudiante:id_estudiante,fecha:fecha}, function(data) {
        if(data === 0){
            $('#merror').show('fast').delay(4000).hide('fast');
        }
        else{
    ...
    function sel(id){
    $.post('ws/alternativa_sugerida.php', {op: 'get', id: id}, function(data) {
        if(data !== 0){
                ...
                $('#id').val(data.id);
                    ...
                    echo $gl_alternativa_sugerida_id_pregunta_encuesta;
                    ?>);
            ...
            $('#texto').val(data.texto);
                    ...
                    echo $gl_alternativa_sugerida_id_estudiante;
                    ?>);
    ...
    function del(id){
        $.post('ws/alternativa_sugerida.php', {op: 'del', id: id}, function(data) {
            if(data === 0){
                $('#merror').show('fast').delay(4000).hide('fast');
            }
            else{
