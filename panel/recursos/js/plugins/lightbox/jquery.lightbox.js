        ...
        LightBoxObject: {
                    ...
                    $(esqueleto.image).load(this.proxy(function()
                    {
                        ...
                        else
                        {
                            if (options.autoresize)
                            {
                                ...
                                // Si el tama�o calculado no coincide con el tama�o real, mostraremos la botonera para "agrandar" imagen:
            ...
            resize: function(x, y)
            {
                ...
                if (this.visible)
                {
                    ...
                    this.morph(esqueleto.background.stop(), {'width': x, 'height': y}, 'move', function() {
                        $(esqueleto.background).trigger('complete');
                    });
                }
                else
                {
            ...
            utils: {
                isEmpty: function(obj)
                {
                    if (obj == null)
                        return true;
                    if (Object.prototype.toString.call(obj) === '[object String]' || $.type(obj) === "array")
                        return obj.length === 0;
                }
            }
